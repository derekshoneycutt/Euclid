...
const ODIN_ABI_TYPE_ALIASES = Dict(
    ...
    "shapemodel.Bridge_Inline_Box_Dims" => "bridge-inline-box-dims",
    "core.Bridge_Inline_Size" => "bridge-inline-size",
    "shapemodel.Bridge_Inline_Size" => "bridge-inline-size",
    "core.Bridge_Inline_Perpendicular_Dims" => "bridge-inline-perpendicular-dims",
    "shapemodel.Bridge_Inline_Perpendicular_Dims" => "bridge-inline-perpendicular-dims",
    "core.Bridge_Perpendicular_Colors" => "bridge-perpendicular-colors",
    "shapemodel.Bridge_Perpendicular_Colors" => "bridge-perpendicular-colors",
    "core.Bridge_Pie_Section_Geometry" => "bridge-pie-section-geometry",
    "shapemodel.Bridge_Pie_Section_Geometry" => "bridge-pie-section-geometry",
    "core.Bridge_Arc_Geometry" => "bridge-arc-geometry",
    "shapemodel.Bridge_Arc_Geometry" => "bridge-arc-geometry",
    "shapemodel.Bridge_Circle_Region_Geometry" => "bridge-circle-region-geometry",
    "shapemodel.Bridge_Trochoid_Geometry" => "bridge-trochoid-geometry",
    "shapemodel.Bridge_Trochoid_Tool_Geometry" => "bridge-trochoid-tool-geometry",
    "shapemodel.Bridge_Cycloid_Geometry" => "bridge-cycloid-geometry",
    "shapemodel.Bridge_Cycloid_Tool_Geometry" => "bridge-cycloid-tool-geometry",
    "core.Bridge_Label_Glyph" => "bridge-label-glyph",
    "shapemodel.Bridge_Label_Glyph" => "bridge-label-glyph",
    "core.Bridge_Square_Vertices" => "bridge-square-vertices",
    "shapemodel.Bridge_Square_Vertices" => "bridge-square-vertices",
    "core.Bridge_Pentagon_Vertices" => "bridge-pentagon-vertices",
    "shapemodel.Bridge_Pentagon_Vertices" => "bridge-pentagon-vertices",
    "core.Shapes_Line" => "bridge-shape-line",
    "shapemodel.Shapes_Line" => "bridge-shape-line",
    "core.Shapes_Circle" => "bridge-shape-circle",
    "shapemodel.Shapes_Circle" => "bridge-shape-circle",
    "core.Shapes_Filled_Circle" => "bridge-shape-filled-circle",
    "shapemodel.Shapes_Filled_Circle" => "bridge-shape-filled-circle",
    "core.Shapes_Triangle" => "bridge-shape-triangle",
    "shapemodel.Shapes_Triangle" => "bridge-shape-triangle",
    "core.Shapes_Square" => "bridge-shape-square",
    "shapemodel.Shapes_Square" => "bridge-shape-square",
    "core.Shapes_Pentagon" => "bridge-shape-pentagon",
    "shapemodel.Shapes_Pentagon" => "bridge-shape-pentagon",
    "Bridge_Shape_Style" => "bridge-shape-style",
    "Bridge_Positioned_Shape_Input" => "bridge-positioned-shape-input",
    "Bridge_Distance_Constraint_Input" => "bridge-distance-constraint-input",
    "Bridge_Angle_Constraint_Input" => "bridge-angle-constraint-input",
    "Bridge_Shape_Entity_Result" => "bridge-shape-entity-result",
    "Bridge_Shape_Line_Result" => "bridge-shape-line-result",
    "Bridge_Shape_Arc_Result" => "bridge-shape-arc-result",
    "Bridge_Shape_Circle_Region_Result" => "bridge-shape-circle-region-result",
    "Bridge_Shape_Arc_Query_Result" => "bridge-shape-arc-query-result",
    "Bridge_Shape_Trochoid_Result" => "bridge-shape-trochoid-result",
    "Bridge_Shape_Trochoid_Query_Result" => "bridge-shape-trochoid-query-result",
    "Bridge_Shape_Cycloid_Result" => "bridge-shape-cycloid-result",
    "Bridge_Shape_Cycloid_Query_Result" => "bridge-shape-cycloid-query-result",
    "Bridge_Shape_Triangle_Result" => "bridge-shape-triangle-result",
    "Bridge_Shape_Square_Result" => "bridge-shape-square-result",
    "Bridge_Shape_Pentagon_Result" => "bridge-shape-pentagon-result",
    "Bridge_Shape_View" => "bridge-shape-view",
    "Bridge_Label_Copy_Result" => "bridge-label-copy-result",
    "[3]Vector3" => "vector3-f32-x3",
    "[3]core.Vector3" => "vector3-f32-x3",
    "[3]rl.Vector3" => "vector3-f32-x3",
...
const JULIA_ABI_TYPE_ALIASES = Dict(
    ...
    "BridgePointView" => "bridge-shape-view",
    ...
    "BridgeCircleRegionGeometry" => "bridge-circle-region-geometry",
    "BridgeTrochoidGeometry" => "bridge-trochoid-geometry",
    "BridgeTrochoidToolGeometry" => "bridge-trochoid-tool-geometry",
    "BridgeCycloidGeometry" => "bridge-cycloid-geometry",
    "BridgeCycloidToolGeometry" => "bridge-cycloid-tool-geometry",
    ...
    "BridgeShapeLine" => "bridge-shape-line-result",
    "BridgeShapeCircle" => "bridge-shape-arc-result",
    "BridgeShapeFilledCircle" => "bridge-shape-arc-result",
    "BridgeShapeCircleRegion" => "bridge-shape-circle-region-result",
    "BridgeShapeArcQueryResult" => "bridge-shape-arc-query-result",
    "BridgeShapeTrochoidResult" => "bridge-shape-trochoid-result",
    "BridgeShapeTrochoidQueryResult" => "bridge-shape-trochoid-query-result",
    "BridgeShapeCycloidResult" => "bridge-shape-cycloid-result",
    "BridgeShapeCycloidQueryResult" => "bridge-shape-cycloid-query-result",
    "BridgeShapeTriangle" => "bridge-shape-triangle-result",
    "BridgeShapeSquare" => "bridge-shape-square-result",
    "BridgeShapePentagon" => "bridge-shape-pentagon-result",
    "BridgeShapeStyle" => "bridge-shape-style",
    "BridgePositionedShapeInput" => "bridge-positioned-shape-input",
    "BridgeDistanceConstraintInput" => "bridge-distance-constraint-input",
    "BridgeAngleConstraintInput" => "bridge-angle-constraint-input",
    "BridgeShapeEntityResult" => "bridge-shape-entity-result",
    "BridgeLabelCopyResult" => "bridge-label-copy-result",
    "NTuple{3,NTuple{3,Cfloat}}" => "vector3-f32-x3",
    "Ptr{Cint}" => "pointer-i32", "Ptr{Int32}" => "pointer-i32",
    "Ref{Int32}" => "pointer-i32",
    "Ptr{Cfloat}" => "pointer-f32", "Ref{Cfloat}" => "pointer-f32",
    "Ptr{UInt8}" => "pointer-u8",
    "Int64" => "i64", "Int32" => "i32", "Cint" => "i32",
    "UInt8" => "u8", "UInt16" => "u16", "UInt64" => "u64", "Cfloat" => "f32",
    "Bool" => "bool")
