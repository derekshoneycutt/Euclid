...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({ hash: true, template: './web/template.html', filename: 'ElementsBook1_AddedAxioms_015-HighlightingCircles.html' }),
        new HtmlWebpackPlugin({ hash: true, template: './web/template.html', filename: 'ElementsBook1_AddedAxioms_016-MovingCircles.html' }),
        new HtmlWebpackPlugin({ hash: true, template: './web/template.html', filename: 'ElementsBook1_AddedAxioms_017-IntersectingCircleLine.html' }),
        new HtmlWebpackPlugin({ hash: true, template: './web/template.html', filename: 'ElementsBook1_AddedAxioms_018-IntersectingCircles.html' }),
    ],
