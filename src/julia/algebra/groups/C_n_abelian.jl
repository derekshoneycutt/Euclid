...
const AnimationId = UUID("ab55384b-ed8e-5a51-b367-4ea2b4fbd9fb")
...
"""Complete immutable state for one abelian animation generation."""
...
AnimationCatalog.animation(
    EuclidAlgebraGroupsCnAbelian.AnimationId,
