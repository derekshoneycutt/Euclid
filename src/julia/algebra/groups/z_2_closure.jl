...
const AnimationId = UUID("7224b6e5-b665-541d-9cc6-dc09c4cc380f")
...
"""Complete immutable state for one closure animation generation."""
...
AnimationCatalog.animation(
    EuclidAlgebraGroupsZ2Closure.AnimationId,
