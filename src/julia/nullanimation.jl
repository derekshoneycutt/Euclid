...
function init_null_animation(state_ptr::Ptr{Cvoid})
...
function null_animation_draw_circle(state_ptr::Ptr{Cvoid}, dt::Float32)
...
function loop_null_animation(state_ptr::Ptr{Cvoid}, dt::Float32)
    null_animation_draw_line(state_ptr, dt)
    null_animation_draw_circle(state_ptr, dt)
end
