...
function euclid_lock_pen_joint1(state_ptr::Ptr{Cvoid}, x::Float32, y::Float32, z::Float32)
    pos = (x, y, z)
...
function euclid_move_pen_joint1(state_ptr::Ptr{Cvoid}, x::Float32, y::Float32, z::Float32)
    pos = (x, y, z)
...
function euclid_lock_pen_joint2(state_ptr::Ptr{Cvoid}, x::Float32, y::Float32, z::Float32)
    pos = (x, y, z)
...
function euclid_move_pen_joint2(state_ptr::Ptr{Cvoid}, x::Float32, y::Float32, z::Float32)
    pos = (x, y, z)
...
function euclid_move_compass_joint1(state_ptr::Ptr{Cvoid}, x::Float32, y::Float32, z::Float32)
    pos = (x, y, z)
...
function euclid_move_compass_joint2(state_ptr::Ptr{Cvoid}, x::Float32, y::Float32, z::Float32)
    pos = (x, y, z)
