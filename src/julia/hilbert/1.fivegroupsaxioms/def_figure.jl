...
const AnimationId = UUID("71d6cce5-385d-57d5-bbcd-209393b3ca15")
...
struct AnimationState
    ...
    line3_joint2::Int64
    triangle_host::Int64
    triangle_joint1::Int64
    triangle_joint2::Int64
    triangle_joint3::Int64
    phase::Float32
    timer::Float32
end
...
function with_timing(state::AnimationState, phase::Float32, timer::Float32)
    return AnimationState(
        ...
        state.triangle_host, state.triangle_joint1, state.triangle_joint2,
        state.triangle_joint3, phase, timer)
end
...
function reset_cycle_state(state_ptr::Ptr{Cvoid}, state::AnimationState)
    ...
    triangle_host_id = state.triangle_host
...
AnimationCatalog.animation(
    HilbertChapterOneDefinitionFigure.AnimationId,
    HilbertChapterOneDefinitionFigure.animation_entry)
