...
const AnimationId = UUID("d60c3564-9f25-5e01-8f60-0b63dd870c05")
...
AnimationCatalog.animation(
    HilbertChapterOneDefSegments.AnimationId,
    HilbertChapterOneDefSegments.animation_entry)
