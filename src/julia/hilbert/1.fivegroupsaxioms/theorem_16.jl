...
const AnimationId = UUID("ad0416c5-2429-5ae3-8143-2594a6aca758")
...
function initialize(state_ptr::Ptr{Cvoid})
    ...
    edge_c_prime_a_prime = OdinJuliaBridge.create_new_line(
        state_ptr, EdgeCPrimeAPrimeStart,
        EdgeCPrimeAPrimeStart, EdgeCPrimeAPrimeColor, 0f0)
    ...
    state = AnimationState(
        ...
        edge_b_c.joint1_id, edge_b_c.joint2_id, edge_c_a.host_id, edge_c_a.joint1_id,
        edge_c_a.joint2_id, edge_a_prime_b_prime.host_id,
...
AnimationCatalog.animation(
    HilbertChapterOneTheorem16.AnimationId, HilbertChapterOneTheorem16.animation_entry)
