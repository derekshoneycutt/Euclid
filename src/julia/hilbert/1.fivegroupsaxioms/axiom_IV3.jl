...
function initialize(state_ptr::Ptr{Cvoid})
    ...
    point_c_prime = OdinJuliaBridge.create_new_point(state_ptr, PointCPrime, PointCPrimeColor, 0f0)
    ...
    OdinJuliaBridge.set_animation_meta(
        state_ptr, MetaLabelAPrimeLineId, Float32(label_a_prime_line.index))
