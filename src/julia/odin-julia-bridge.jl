...
Public functions: `dynview_style_with_font_flags`, `bridge_color`, `set_null_animations`, `add_root_animation_interface`, `add_child_animation_interface`, `create_new_label`, `create_new_label_decorated`, `create_new_point`, `create_new_line`, `create_new_circle`, `create_new_filledcircle`, `create_new_triangle`, `create_new_square`, `create_new_pentagon`, `get_point`, `show_point`, `hide_point`, `hide_point_batch`, `set_point_position`, `set_point_brush`, `set_point_color`, `set_point_active_color`, `notify_animation_cycle_boundary`, `dynview_reset_stream`, `dynview_begin_block`, `dynview_text_run`, `dynview_text_run_brush`, `dynview_math_glyph_run`, `dynview_math_block_from_ops`, `dynview_copyable_text_run`, `dynview_inline_line`, `dynview_inline_box`, `dynview_inline_circle`, `dynview_inline_line_brush`, `dynview_inline_box_brush`, `dynview_inline_circle_brush`, `dynview_inline_filled_box`, `dynview_inline_filled_circle`, `dynview_inline_pie_section`, `dynview_line_break`, `dynview_end_block`, `get_bridge_version`, `get_bridge_feature_flags`, `get_point_capacity`, `get_point_next_index`, `is_point_index_in_range`, `set_point_draw_enabled`, `set_point_position_status`, `clear_point_position`, `set_point_color_status`, `clear_point_color`, `set_point_active_color_status`, `clear_point_active_color`, `set_point_brush_size`, `set_point_offset`, `attach_child_point`, `detach_child_point`, `rebuild_child_count`, `validate_parent_child_chain`, `get_constraint_capacity`, `get_constraint_next_index`, `is_constraint_index_in_range`, `get_constraint_view`, `create_constraint`, `update_constraint`, `set_constraint_enabled`, `clear_constraint`, `get_total_constraint_error_bridge`, `get_constraint_error_bridge`, `apply_constraint_bridge`, `apply_all_constraints_bridge`, `solve_constraints_to_error`, `get_shape_line_view`, `get_shape_circle_view`, `get_shape_filledcircle_view`, `get_shape_triangle_view`, `get_shape_square_view`, `get_shape_pentagon_view`, `get_pen_view`, `get_compass_view`, `get_shapes_anim_points_start`, `get_shapes_anim_constraints_start`, `freeze_shapes_animation_boundary`, `clear_shapes_animation_data`, `get_max_shapes_points`, `get_max_shapes_constraints`, `validate_shapes_graph`, `show_pen`, `hide_pen`, `set_pen_active`, `clear_pen_active`, `lock_pen_joint1`, `unlock_pen_joint1`, `move_pen_joint1`, `get_pen_joint1_position`, `lock_pen_joint2`, `unlock_pen_joint2`, `move_pen_joint2`, `get_pen_joint2_position`, `show_compass`, `hide_compass`, `set_compass_active`, `clear_compass_active`, `lock_compass_joint1`, `unlock_compass_joint1`, `move_compass_joint1`, `get_compass_joint1_position`, `lock_compass_joint2`, `unlock_compass_joint2`, `move_compass_joint2`, `get_compass_joint2_position`, `set_animation_meta`, `get_animation_meta`, `emit_trailing_particle`, and `emit_flicker_particle`.
"""
...
export BridgeColor, BridgePointView, BridgeConstraintView, BridgeConstraintSpec, BridgeSolveResult,
    ...
    dynview_reset_stream, dynview_begin_block, dynview_text_run, dynview_text_run_brush,
    dynview_math_glyph_run,
