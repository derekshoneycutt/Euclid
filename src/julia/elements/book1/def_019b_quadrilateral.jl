...
const SquareBaseColor = EuclidBridge.bridge_color(SquareColor)
...
function reset_cycle_state(state_ptr::Ptr{Cvoid})
    ...
    EuclidBridge.hide_point_batch(state_ptr, [line1HostId, line2HostId, line3HostId, line4HostId, shapeHostId])
    ...
    EuclidBridge.set_pen_active(state_ptr, 0, SquareColor)
...
function initialize(state_ptr::Ptr{Cvoid})
    ...
    EuclidBridge.set_animation_meta(state_ptr, MetaShapeHostId, Float32(square.hostId))
    EuclidBridge.set_animation_meta(state_ptr, MetaShapeJoint1Id, Float32(square.joint1Id))
    EuclidBridge.set_animation_meta(state_ptr, MetaShapeJoint2Id, Float32(square.joint2Id))
    EuclidBridge.set_animation_meta(state_ptr, MetaShapeJoint3Id, Float32(square.joint3Id))
    EuclidBridge.set_animation_meta(state_ptr, MetaShapeJoint4Id, Float32(square.joint4Id))
