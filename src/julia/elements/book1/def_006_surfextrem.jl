...
const AnimationId = UUID("b2f240b3-12c1-5908-a7fb-4a0315929980")
...
AnimationCatalog.animation(
    ElementsOneDefinitionSurfaceExtremity.AnimationId,
    ElementsOneDefinitionSurfaceExtremity.animation_entry)
