...
const SideLength = VertexC[1] - VertexA[1]
const EquilateralHeight = SideLength * Float32(sqrt(3f0)) / 2f0
const VertexB = [
    (VertexA[1] + VertexC[1]) / 2f0,
    VertexA[2] - EquilateralHeight,
    0f0,
]
const PenTopZ = 1.4f0
...
function get_view_text(state_ptr::Ptr{Cvoid})
    fallback = """Euclid Elements - Book I - Definition: Equilateral Triangle
...
function reset_cycle_state(state_ptr::Ptr{Cvoid})
    ...
    OdinJuliaBridge.hide_point_batch(state_ptr, [line1_host_id, line2_host_id, line3_host_id])
