...
const AnimationId = UUID("142a4b16-0a1f-58f5-8599-823b8d3d2821")
...
AnimationCatalog.animation(
    ElementsOneDefinitionObtuseAngle.AnimationId,
    ElementsOneDefinitionObtuseAngle.animation_entry)
