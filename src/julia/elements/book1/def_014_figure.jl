...
const AnimationId = UUID("cc73ce96-0e8a-576c-9b2e-daa3b559c9ff")
...
"""Stable native handles for one triangle owned by the animation."""
struct TriangleIds
    host::Int64
    joint1::Int64
    joint2::Int64
...
"""Complete immutable state for one figure animation generation."""
...
function reset_cycle_state(state_ptr::Ptr{Cvoid}, state::AnimationState)
    ...
    line1_host_id = line1.host
    line1_joint2_id = line1.joint2
    line2_host_id = line2.host
    line2_joint2_id = line2.joint2
    line3_host_id = line3.host
    line3_joint2_id = line3.joint2
...
function initialize(state_ptr::Ptr{Cvoid})
    triangle = OdinJuliaBridge.create_new_triangle(
        state_ptr, VertexA, VertexB, VertexC, TriangleColor)
    ...
    state = AnimationState(
        ...
        TriangleIds(triangle.host_id, triangle.joint1_id,
...
function loop(state_ptr::Ptr{Cvoid}, dt::Float32)
    ...
    line1, line2, line3 = state.lines
    line1_host_id = line1.host
    line1_joint1_id = line1.joint1
    line1_joint2_id = line1.joint2
    line2_host_id = line2.host
    line2_joint1_id = line2.joint1
    line2_joint2_id = line2.joint2
    line3_host_id = line3.host
    line3_joint1_id = line3.joint1
    line3_joint2_id = line3.joint2
    triangle_host_id = state.triangle.host
        ...
        if timer <= FlickerDuration
            for _ in 1:FlickerSamplesPerFrame
                ...
                OdinJuliaBridge.emit_flicker_particle(
                    state_ptr, sample_pos, FlickerColor)
            end
        end
...
AnimationCatalog.animation(
    ElementsOneDefinitionFigure.AnimationId, ElementsOneDefinitionFigure.animation_entry)
