...
vector_dust_field_apply_tool_point :: proc(
    field: ^Vector_Dust_Field_State, position: rl.Vector2) -> u64 {
    ...
    for y in first_y..=last_y {
        for x in first_x..=last_x {
            ...
            if density <= VECTOR_DUST_DENSITY_EPSILON || distance_sq == 0 ||
