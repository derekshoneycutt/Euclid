...
const AnimationId = UUID("1e893976-4bb4-573a-bc2d-b097eb312f98")
...
function initialize(state_ptr::Ptr{Cvoid})
    ...
    label_o_double_prime = OdinJuliaBridge.create_new_label(
        state_ptr, "O″",
        LabelODoublePrimePoint, LabelColor, 16f0)
    label_h_double_prime = OdinJuliaBridge.create_new_label(
        state_ptr, "h″",
        LabelHDoublePrimePoint, LabelColor, 16f0)
    label_k_double_prime = OdinJuliaBridge.create_new_label(
        state_ptr, "k″",
...
AnimationCatalog.animation(
    HilbertChapterOneAxiomIV5.AnimationId, HilbertChapterOneAxiomIV5.animation_entry)
