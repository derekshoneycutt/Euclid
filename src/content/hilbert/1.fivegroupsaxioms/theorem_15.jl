...
const AnimationId = UUID("968ab5d1-72e6-50d8-aea3-02775f05c29d")
...
struct AnimationState
    ...
    label_ddouble_id::UInt64
    label_dtriple_id::UInt64
    phase::Float32
    timer::Float32
end
...
function initialize(state_ptr::Ptr{Cvoid})
    ...
    label_d_double = OdinJuliaBridge.create_new_label(
        state_ptr, "D″",
        LabelDDoublePoint, LabelColor, 16f0)
    label_d_triple = OdinJuliaBridge.create_new_label(
        state_ptr, "D‴",
...
AnimationCatalog.animation(
    HilbertChapterOneTheorem15.AnimationId, HilbertChapterOneTheorem15.animation_entry)
