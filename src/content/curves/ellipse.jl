...
const Semimajor = 0.25f0
const Semiminor = 0.14f0
const FixedRadius = Semimajor + Semiminor
const RollingRadius = (Semimajor + Semiminor) / 2f0
const TracerDistance = (Semimajor - Semiminor) / 2f0
...
"""Immutable native identity and cycle timing for the ellipse construction."""
...
"""Reset the hidden ellipse and elevated instruments for a fresh cycle."""
...
"""Create the persistent ellipse and initialize its first construction cycle."""
function initialize(state_ptr::Ptr{Cvoid})
    curve = OdinJuliaBridge.create_new_ellipse(
        state_ptr, Center, Semimajor, Semiminor;
...
"""Advance the synchronized guide, compass, and persistent ellipse."""
...
"""Dispatch one bridge-stable lifecycle operation for the Ellipse animation."""
...
AnimationCatalog.animation(
    EuclidCurvesEllipse.AnimationId, EuclidCurvesEllipse.animation_entry)