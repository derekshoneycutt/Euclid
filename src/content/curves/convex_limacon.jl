module EuclidCurvesConvexLimacon
...
"""Immutable native identity and cycle timing for the convex limaçon construction."""
...
"""Reset the hidden convex limaçon and elevated instruments for a fresh cycle."""
...
"""Create the persistent convex limaçon and initialize its first cycle."""
...
"""Advance the synchronized guide, compass, and persistent convex limaçon."""
...
"""Dispatch one bridge-stable lifecycle operation for the Convex Limaçon animation."""
...
AnimationCatalog.animation(
    EuclidCurvesConvexLimacon.AnimationId,
    EuclidCurvesConvexLimacon.animation_entry)
