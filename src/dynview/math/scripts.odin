...
//   Assemble final script positions and outer bounds from resolved shifts.
math_script_resolved_geometry :: proc(
    input: Math_Script_Geometry_Input,
    sup_raise, sub_drop, space_after: f32) -> Math_Script_Geometry {
...
math_script_geometry :: proc(
    ...
    return math_script_resolved_geometry(input, sup_raise, sub_drop, space_after)
}