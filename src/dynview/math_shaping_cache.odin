...
Math_Glyph_Variants_Request :: struct {
    generation: u64,
    glyph_id: u32,
    output: []core.Font_Math_Glyph_Variant,
}
...
Math_Glyph_Assembly_Request :: struct {
    generation: u64,
    glyph_id: u32,
    output: []core.Font_Math_Glyph_Part,
}
...
Math_Glyph_Kern_Table_Request :: struct {
    ...
    glyph_id: u32,
    corner: u8,
    output: []core.Font_Math_Kern_Entry,
}
...
cache_math_kern_record :: proc(
    ...
    glyph_id: u32,
    corner: u8,
    record: ^core.Font_Math_Kern_Table) -> bool {
...
cache_math_kern_records :: proc(
    ...
    tables, allocation_error := make(
        []core.Font_Math_Kern_Table, count, allocator)
...
cache_math_accent_source :: proc(
    service: Math_Shaping_Service,
    base: core.Font_Math_Glyph_Variant,
    source: ^core.Font_Math_Stretch_Source) -> bool {
...
math_accent_base_variant :: proc(
    service: Math_Shaping_Service,
    text: string,
    flattened: bool) -> (core.Font_Math_Glyph_Variant, bool) {
...
cache_math_accent_source_records :: proc(
    ...
    cache := &runtime^.compile_cache
    allocator := core.arena_owner_allocator(arena)
    sources, allocation_error := make([][2]core.Font_Math_Stretch_Source,
