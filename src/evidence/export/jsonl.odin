...
EVENT_KIND_NAMES :: #sparse [trace.Kind]string{
    ...
    .Trochoid_Geometry_Committed = "trochoid.geometry_committed",
    .Trochoid_Frontier_Committed = "trochoid.frontier_committed",
    .Cycloid_Geometry_Committed = "cycloid.geometry_committed",
    .Cycloid_Frontier_Committed = "cycloid.frontier_committed",
    ...
    .Trochoid_Tool_Geometry_Committed = "trochoid_tool.geometry_committed",
    .Trochoid_Tool_Parameter_Committed = "trochoid_tool.parameter_committed",
    .Cycloid_Tool_Geometry_Committed = "cycloid_tool.geometry_committed",
    .Cycloid_Tool_Parameter_Committed = "cycloid_tool.parameter_committed",
