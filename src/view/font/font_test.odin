...
view_test_prepare_regular :: proc(t: ^testing.T) {
    ...
    testing.expect_value(t, prepared.base_size, i32(64))
    testing.expect_value(t, prepared.glyph_count, i32(6795))
    testing.expect_value(t, prepared.padding, i32(4))
    testing.expect_value(t, prepared.atlas_width, i32(8192))
    testing.expect_value(t, prepared.atlas_height, i32(4096))
    testing.expect_value(t, len(prepared.glyphs), 6795)
    testing.expect_value(t, len(prepared.rectangles), 6795)
    testing.expect_value(t, len(prepared.atlas_pixels), 8192*4096*2)
    testing.expect_value(t, prepared.glyphs[0].value, rune(' '))
    testing.expect_value(t, prepared.glyphs[0].advance_x, i32(32))
    testing.expect_value(t, prepared.glyphs[0].bitmap_width, i32(32))
    testing.expect_value(t, prepared.glyphs[0].bitmap_height, i32(64))
