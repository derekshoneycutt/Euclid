...
container_fill_color :: #force_inline proc(
    ...
    switch fill_variant {
    case .Dark_Red:
        return ui_raylib_color(BACKGROUND_COLOR)
    case .Grey:
        return ui_raylib_color(UI_COMPONENT_BACKGROUND_COLOR)
    }
...
draw_container_with_border :: proc(
    ...
    if border > 0 {
        rl.DrawRectangleLinesEx(drawn_rect, border, ui_raylib_color(UI_BORDER_COLOR))
    }
