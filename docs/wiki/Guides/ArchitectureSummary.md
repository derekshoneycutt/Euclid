...
| **Odin** | Rendering and UI | Frame loop wiring, shader contracts, framebuffer capture, world rendering, panel rendering, and interaction routing. | `src/view/view.odin`, `src/view/render/shader/`, `src/view/capture/`, `src/view/elements.odin`, `src/view/core/view_core.odin`, `src/view/core/isomath.odin`, `src/view/ui/ui.odin` |
