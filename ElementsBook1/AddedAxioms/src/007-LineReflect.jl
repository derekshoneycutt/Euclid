...
- `x_axis::Float32`: The position of the x-axis to reflect on
"""
function reflect(line::EuclidLine2f; x_axis::Float32=0f0)
    EuclidLine2fReflect(line, x_axis, line.extremityA[], line.extremityB[])
end
...
- `x_axis::Float32`: The position of the x-axis to reflect on
"""
function reset(reflect::EuclidLine2fReflect; x_axis::Float32=reflect.reflect_x)
