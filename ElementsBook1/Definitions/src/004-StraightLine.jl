...
"""
mutable struct EuclidStraightLine2f
    baseOn::EuclidLine2f
    straight_markers::Vector{EuclidPoint2f}
    marker_moves::Vector{EuclidPoint2fMove}
end
...
# Arguments
- `line::EuclidStraightLine2f`: The description of the highlight to completely hide markers for
"""
function hide(line::EuclidStraightLine2f)
    for move in line.marker_moves
        hide(move)
    end
    for marker in line.straight_markers
...
# Arguments
- `line::EuclidStraightLine2f`: The line to animate in the diagram
...
"""
function animate(
    line::EuclidStraightLine2f, hide_until::AbstractFloat, end_at::AbstractFloat, t::AbstractFloat)
