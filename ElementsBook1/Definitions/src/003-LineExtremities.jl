...
"""
mutable struct EuclidLine2fHighlightExtremities
    baseOn::EuclidLine2f
    extremity_A::EuclidPoint2f
    highlight_A::EuclidPoint2fHighlight
    extremity_B::EuclidPoint2f
    highlight_B::EuclidPoint2fHighlight
end
...
# Arguments
- `line::EuclidLine2fHighlightExtremities`: The description of the highlight to finish
"""
function show_complete(line::EuclidLine2fHighlightExtremities)
...
# Arguments
- `line::EuclidLine2fHighlightExtremities`: The description of the highlight to completely hide
"""
function hide(line::EuclidLine2fHighlightExtremities)
...
# Arguments
- `line::EuclidLine2fHighlightExtremities`: The line to animate in the diagram
...
"""
function animate(
    line::EuclidLine2fHighlightExtremities, hide_until::AbstractFloat, max_at::AbstractFloat, min_at::AbstractFloat, t::AbstractFloat)
