...
function text(at_spot::Point2f, text;
    ...
    observable_text = Observable(text)
    text(observable_location, observable_text, color=color, opacity=opacity)
end
...
"""
function hide(text::EuclidText2f)
...
"""
function animate(
    text::EuclidText2f, hide_until::AbstractFloat, max_at::AbstractFloat, t::AbstractFloat;
